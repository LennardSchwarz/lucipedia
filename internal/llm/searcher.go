...
// Searcher defines the behaviour for discovering relevant Lucipedia slugs.
...
func (s *openRouterSearcher) Search(ctx context.Context, query string, numResults int) ([]string, error) {
...
func (s *openRouterSearcher) logError(fields logrus.Fields, err error, message string) {
...
var _ Searcher = (*openRouterSearcher)(nil)
